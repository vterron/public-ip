    ...
    @parameterized.named_parameters(
        {
            ...
            'answers': {
                'http://api.ipify.org': '1.1.1.1',
                'http://checkip.amazonaws.com': '1.1.1.1',
                'http://icanhazip.com': '1.1.1.1',
                'http://ifconfig.co/ip': '1.1.1.1',
                'http://ipecho.net/plain': '1.1.1.1',
                'http://ipinfo.io/ip': '1.1.1.1',
             },
            "want":  '1.1.1.1',
        },
        {
